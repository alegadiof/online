...
<body>
			...
			<div class="carousel-inner">
				<div class="carousel-item active" style="height: 80vh">
					...
					<div class="carousel-caption d-none d-md-block">
						<h5 class="display-4 mb-4 font-weight-bold">Proyecto InnovAula</h5>
	...
	<nav class="navbar navbar-dark bg-dark  navbar-expand-md navbar-light bg-light fixed-top">
		<div class="text-white bg-success p-2">
			<?php
			echo $_SESSION["avatar"]. $_SESSION["Nombre"]." ". $_SESSION["Apellidos"];
			?>
		</div>
		<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
			<div class="navbar-nav mr-auto">
				...
				<a class="nav-item nav-link text-justify ml-3 hover-primary" href="controlador/controlador_cerrarsesion.php">Salir</a>
			</div>
